...
<%
    ...
    Collection<?> ordersByUser = (Collection<?>) request.getAttribute("ordersByUser");
	if(ordersByUser == null) {
		response.sendRedirect("./OrdersByUser");
		return;
	}
%>
				...
				<h2>Orders By Date</h2>
					<div class = "container">
						<table border="1">
							...
							<%
								if (ordersByUser != null && ordersByUser.size() != 0) {
									Iterator<?> it = ordersByUser.iterator();
									while (it.hasNext()) {
