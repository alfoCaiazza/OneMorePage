<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
       ...
       <%
    	...
    	if(pagamento == null) {
    		response.sendRedirect("./PaymentControl");
    		return;
    	}
    %> 
...
<!DOCTYPE html>
    ...
    function closeNav() {
      document.getElementById("mySidenav").style.width = "0";
		...
		<div class="container-payment">
				<h2>Seleziona carta di credito</h2>
		<table border="1">
		<tr>
			<th>Codice Carta</th>
			<th>Intestatario</th>
		...
		<tr>
			...
			<td><a class="delbtn" href="userLogged.jsp">Select</a></td>
		</tr>
		<%
				}
			} else {
	...
	<div class="former">
	<form  action="./PaymentControl" onSubmit="return ValidateCard();">
			...
			<input type="number" name="cvc" id="cvc" required placeholder="000"><br>
			...
			<input type="text"  id="anno" name="anno" required  placeholder = "YYYY">
