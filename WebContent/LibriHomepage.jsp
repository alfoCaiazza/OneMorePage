...
Collection<?> products = (Collection<?>) request.getAttribute("products");
		if(products == null) {
	response.sendRedirect("./HeaderLibri");
	return;
		}
...
<div class="container-home">
	<section class="product">
		...
		<button id="pre-btn" class="pre-btn"><img src="img/arrow.png" alt ="NONE"></button>
		<button id="nxt-btn" class="nxt-btn"><img src="img/arrow.png" alt ="NONE"></button>
